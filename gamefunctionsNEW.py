...
"""Utility functions for a text-based RPG game.

This module provides reusable functions for printing welcome messages,
displaying shop menus, handling item purchases, and generating random
monsters with varying values.

Typical usage example:

  import gamefunctions

  gamefunctions.print_welcome("Bryan", 30)
...
def test_functions():
    """Run demonstration tests for all functions in this module."""
